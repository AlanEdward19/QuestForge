...
namespace QuestForge.CharacterService.Controllers
{
    ...
    public class BackgroundController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(
            [FromServices] IHandler<GetBackgroundQuery, BackgroundAggregateRoot> handler,
        ...
        public async Task<IActionResult> Post(
            [FromServices] IHandler<CreateBackgroundCommand, DatabaseOperationViewModel> handler,
        ...
        public async Task<IActionResult> Patch(
            [FromServices] IHandler<UpdateBackgroundCommand, DatabaseOperationViewModel> handler,
            [FromBody] UpdateBackgroundCommand command, [FromQuery] Guid id, CancellationToken cancellationToken)
        {
            command.SetId(id);
            return Ok(await handler.Handle(command, cancellationToken));
        }
        ...
        public async Task<IActionResult> Delete(
            [FromServices] IHandler<DeleteBackgroundCommand, DatabaseOperationViewModel> handler,
