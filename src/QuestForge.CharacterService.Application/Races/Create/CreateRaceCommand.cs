...
public class CreateRaceCommand(string? name, string? description, Dictionary<EAbilityScore, int>? abilityScoreIncrease, double? movement, IEnumerable<Guid> featureIds) : Command
{
